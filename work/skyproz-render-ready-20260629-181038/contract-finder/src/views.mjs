...
<body>
  ...
  <footer><a class="brand" href="/"><span class="brand-mark">S</span><span><strong>SKYPROZ</strong><small>SERVICES</small></span></a><p>Contract and tender intelligence for ambitious businesses.</p><p>© ${new Date().getFullYear()} Skyproz Services</p></footer>
