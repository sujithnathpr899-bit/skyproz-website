...
const templates = [
  ['TED Europe', 'https://ted.europa.eu/en/', 'https://api.ted.europa.eu/v3/notices/search', 'European Union', 'government', tedMap, 0, 'ted', 'Europe', 'daily', { provider: 'TED', compliance: 'Official TED Public API v3. Uses POST /v3/notices/search.' }, 'rest', 'https://api.ted.europa.eu', '', { accept: 'application/json', 'content-type': 'application/json' }, {}, { mode: 'PAGE_NUMBER', limit: 10 }, 1000, 'disabled'],
  ['SAM.gov Opportunities', 'https://sam.gov/content/opportunities', 'https://api.sam.gov/prod/opportunities/v2/search?limit=25&api_key={api_key}', 'United States', 'government', { ...jsonMap, items_path: 'opportunitiesData' }, 0, 'sam', 'North America', 'daily', { provider: 'SAM.gov', compliance: 'Official API requires SAM_API_KEY' }, 'rest', 'https://api.sam.gov', 'SAM_API_KEY', {}, { api_key_env: 'SAM_API_KEY' }, {}, 1000, 'disabled'],
  ['World Bank Procurement Notices', 'https://projects.worldbank.org/en/projects-operations/procurement', 'https://search.worldbank.org/api/v3/procurement/notice?format=json&rows=25', 'Worldwide', 'government', { ...jsonMap, items_path: 'procurementnotice' }, 0, 'worldbank', 'Global', 'daily', { provider: 'World Bank', compliance: 'Public World Bank procurement API template' }, 'rest', 'https://search.worldbank.org', '', {}, {}, {}, 1000, 'disabled'],
  ...
  ['CanadaBuys', 'https://canadabuys.canada.ca/en/tender-opportunities', null, 'Canada', 'government', templateOnly('Configure an official CanadaBuys API/open-data endpoint before enabling import.'), 0, 'canadabuys', 'North America', 'daily', { provider: 'CanadaBuys', compliance: 'Official public procurement template' }, 'json', 'https://canadabuys.canada.ca', '', {}, {}, {}, 1000, 'disabled'],
  ...
  ['GETS New Zealand', 'https://www.gets.govt.nz/', null, 'New Zealand', 'government', templateOnly('Configure an official GETS permitted feed/API before enabling import.'), 0, 'gets', 'Oceania', 'daily', { provider: 'GETS', compliance: 'Official public procurement template' }, 'rss', 'https://www.gets.govt.nz', '', {}, {}, {}, 1000, 'disabled'],
  ...
  ['Saudi Etimad', 'https://tenders.etimad.sa/', null, 'Saudi Arabia', 'government', templateOnly('Configure an official Etimad API/feed before enabling import.'), 0, 'etimad', 'Middle East', 'daily', { provider: 'Etimad', compliance: 'Official public procurement template' }, 'rest', 'https://tenders.etimad.sa', '', {}, {}, {}, 1000, 'disabled'],
  ...
  ['UNDP Procurement Notices', 'https://procurement-notices.undp.org/', null, 'Worldwide', 'government', templateOnly('Configure an official UNDP permitted API/feed before enabling import.'), 0, 'undp', 'Global', 'daily', { provider: 'UNDP', compliance: 'Official procurement notices template' }, 'rest', 'https://procurement-notices.undp.org', '', {}, {}, {}, 1000, 'disabled'],
  ['UNICEF Supply Tender Notices', 'https://www.unicef.org/supply/tender-calendar', null, 'Worldwide', 'government', templateOnly('Configure an official UNICEF permitted API/feed before enabling import.'), 0, 'unicef', 'Global', 'daily', { provider: 'UNICEF', compliance: 'Official supply tender template' }, 'rest', 'https://www.unicef.org', '', {}, {}, {}, 1000, 'disabled']
];
